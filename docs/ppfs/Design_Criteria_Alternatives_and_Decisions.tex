...
The design criteria, alternatives, and decisions for the project were divided into many parts based on the main software and hardware components of the gym reservation system (see \refFig{fig:general_overview}). These main components are described below.
