...
The business plan for this gym reservation system is divided into two parts, which include a marketing study and a cost estimate. The marketing study describes the need for a gym reservation system, and the cost estimate gives a detailed breakdown of the costs involved in implementing such a system.
    ...
    The cost estimate includes both the summary of the development costs during this project and an estimate of the production cost of a system.
        ...
        The vast majority of the budget for this project was used for purchasing sensors. The items purchased are shown in \textbf{Table \ref{tab:devPartCost}}.
        \begin{table}[H]
        	\begin{center}
        		...
        		\begin{tabular}{|c|c|c|c|}
        			...
        			\hline
        			8 & TI SensorTag & \$29 & \$232\\
        			\hline
        			1 & 2.7" Sharp LCD Display & \$20 & \$20\\
        			\hline
        			1 & Raspbeerry Pi 802.15.4 Radio & \$12 & \$12\\
        			\hline
        			2 & TI CC2531 USB Dongle & \$12.52 & \$25.04\\
        			\hline
        			1 & TI CC2531 & \$74.92 & \$74.92\\
        			\hline
        			1 & TP-Link Network Switch & \$9.95 & \$9.95\\
        			\hline
        			1 & Samsung 32 GB Micro SD Card & \$10.08 & \$10.08\\
        			\hline
        			1 & Raspberry Pi 2 Model B & \$35 & \$35\\
        			\hline
        			&&& \$467.99\\
        			\hline
        		\end{tabular}
        ...
        The Raspberry Pi used for the hub was initially a model B+ owned by the Calvin engineering department that was borrowed for the duration of the project. However, part way through the project it was determined that two Raspberry Pis may be necessary and having a more powerful one would be beneficial. A ZigBee wire antenna for the Raspberry Pi was also borrowed from the Calvin engineering department but not used in the final implementation. These items and their values are shown in \textbf{Table \ref{tab:devLoanedItems}}.
        ...
        In order to transition from the prototype developed in this project to a final product, it is estimated that about 1000 hours of additional design time would be required. At \$100 per hour, this would cost \$100000. The total development budget to get an initial commercial product would be about \$125000. This price should be recovered over the first five years of production, and the annual development recovery cost is \$25000.
        ...
        Cloud Server services such as Amazon server will be used for hosting the server. This cost will be a monthly cost, and the cost will scale with the amount of server usage. For typical usage which might be similar to a moderate WordPress installation, a 3-year instance on a small server could cost \$17.95 per month, or \$646.2 for three years. \cite{wordPressEstimate}
