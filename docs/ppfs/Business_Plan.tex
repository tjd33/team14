		...
		\begin{table}[H]
			\begin{center}
				...
				\begin{tabular}{|c|c|}
					...
					\hline
					Amortized Startup Costs & 500\\
					\hline
					Total Cost & 7444\\
					\hline
					Sales Price & \$10000\\
					\hline
					Profit before Tax& \$2556\\
					\hline
					Profit after Tax& \$1661\\
					\hline
				\end{tabular}
			\end{center}
		\end{table}
        
        Using a sales price of \$10000 per system, the resulting profit of \$1661 (shown in Table \ref{tab:SalesPrice}) results in a profit margin of 16.1\%, which is satisfactory the this project.
